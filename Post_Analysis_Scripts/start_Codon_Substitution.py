...
def result_compare(results_file,genome_file):
    ...
    print("Perfect Match Start Codons\nATG:"+str(perfect_Match_Gene_Start_Codons['ATG'])+",GTG:"+str(perfect_Match_Gene_Start_Codons['GTG'])+",TTG:"+
          str(perfect_Match_Gene_Start_Codons['TTG'])+",CTG:"+str(perfect_Match_Gene_Start_Codons['CTG'])+",Other_Start:"+str(perfect_Match_Gene_Start_Codons['Other']))

    strands = collections.defaultdict(int, {'-': 0, '+': 0})
    start_Codon_Substitution = collections.OrderedDict({'ATG-ATG':0,'GTG-ATG':0,'TTG-ATG':0,'CTG-ATG':0,'Alt-ATG':0,
